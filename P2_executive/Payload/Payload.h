/////////////////////////////////////////////////////////////////////
// Payload.h - provie the payload for the repo                     //
// ver 1.0                                                         //
...
* Package Operations:
* -------------------
* This class bases on IPayload.h and supports the repository item.
*   - hasChild: check if the string is in the child key
*   - toXmlElement: create XmlElement that represents PayLoad instance
*   - fromXmlElement: create PayLoad instance from XmlElement
...
namespace NoSqlDb {
	...
	*/
	inline Sptr Payload::toXmlElement() {
		...
		Sptr sPtrPackageNam = XmlProcessing::makeTaggedElement("packageName", packageName_);
		sPtr->addChild(sPtrPackageNam);
